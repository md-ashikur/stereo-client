...
export default function AboutSec1() {
  return (
    <div className="relative">
      ...
      <div className="flex flex-col justify-center items-center px-20 h-screen space-y-10 ">
        <div className="max-w-[820px] text-center mt-16 ">
        ...
        <div className="max-w-[850px] text-xl text-center space-y-3">

  ...
  return (
    <div className="relative ">
      <div>
        ...
        <div className="h-[640px] w-[640px] bg-[#5800B0]  absolute -left-20 lg:-bottom-60 bottom-[50vh] -z-10 rounded-full blur-[120px] opacity-[0.27]"></div>
        <div className="h-[760px] w-[760px] bg-[#5800B0] absolute -right-72 lg:bottom-38 top-[80vh] -z-10 rounded-full blur-[200px] opacity-[0.37]"></div>
        ...
        <div className="my-20">
          ...
          <div className=" relative lg:my-0 my-[16vh]">
            ...
            <div className="flex justify-center">
             <Link href="/faq">  <button className="bg-[#5800B0] hover:scale-[0.95] transition duration-300 ease-in-out rounded-lg shadow-lg my-16 text-white px-4 py-2">
                How does it work ?
              </button></Link>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-5 lg:mt-38 mt-58 lg:space-y-0 space-y-60">
            ...
            <div className="flex flex-col items-center justify-center relative">
              ...
              <div className="bg-white/30 backdrop-blur-sm shadow-lg border border-white rounded-2xl flex flex-col items-center text-center justify-center p-14 space-y-8 !w-full mx-10">
                ...
                <Link href="/how-it-works/creators"><button className="bg-[#5800B0] hover:scale-[0.95] transition duration-300 ease-in-out rounded-lg shadow-lg  text-white px-4 py-2">
            ...
            <div className="flex flex-col items-center justify-center relative">
              ...
              <div className="bg-white/30 backdrop-blur-sm shadow-lg border border-white rounded-2xl flex flex-col items-center text-center justify-center p-14 space-y-8">
                ...
                <p className="lg:text-2xl">
                  Car owners, music lovers, fit fam, entertainment and lifestyle
                  enthusiasts. Working on the road or from home, working out or
                  cooking, this playlist is made for you !
                </p>

                <Link href="/how-it-works/listeners"><button className="bg-[#5800B0] hover:scale-[0.95] transition duration-300 ease-in-out rounded-lg shadow-lg  text-white px-4 py-2">
                  Discover your benefits
                </button></Link>
              </div>
            </div>

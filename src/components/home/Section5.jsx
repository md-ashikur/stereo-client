...
import apptest from "../../../public/images/Jon Adeyole.png";
import keke from "../../../public/images/Adenike Uka.png";
import texi from "../../../public/images/Olamide Obi.png";
import dj from "../../../public/images/apptester.png";
  ...
  return (
    <div className="relative">
      ...
      <div className="lg:ml-20 mx-5 lg:mx-0 mt-20">
        <h1 className="font-bold text-4xl ">What do people think about us ?</h1>
        <div className=" relative ">
          {/* carousel ------------- */}
          <Swiper
            ref={swiperRef}
      ...
      <div className="flex justify-center lg:mx-20 mx-5 lg:my-10 ">
        <div className="bg-white/30 backdrop-blur-sm shadow-lg max-w-[1440px] w-full my-10 border border-white rounded-2xl flex flex-col items-center text-center justify-center p-14 space-y-8">
          ...
          <div className="flex lg:flex-row flex-col gap-6 mb-10">
            ...
            <a href="https://testflight.apple.com/join/J4mFFNAX" target="_blank">

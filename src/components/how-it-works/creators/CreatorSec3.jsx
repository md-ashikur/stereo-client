      ...
      <div className='pt-28 '>
        ...
        <div className='max-w-[845px] mx-auto lg:mt-15'>
            <div className='grid lg:grid-cols-2 py-15 border-t-2 border-white'>
                <h2 className='text-3xl lg:text-4xl font-bold text-[#5800B0]'>Pricing</h2>
                <p className='text-lg lg:px-5'>Pricee depend on your target, location and frequency. Very easy!</p>
            </div>
        </div>
        <div className='max-w-[845px] mx-auto '>
            <div className='grid lg:grid-cols-2 py-15 border-t-2 border-white'>
                <h2 className='text-3xl lg:text-4xl font-bold text-[#5800B0]'>Progress tracking</h2>
                <p className='text-lg lg:px-5'>Follow your ads progression and anticipate your next campaigns!</p>
            </div>
        </div>
        <div className='max-w-[845px] mx-auto '>
            <div className='grid lg:grid-cols-2 py-15 border-t-2 border-white'>
                <h2 className='text-3xl lg:text-4xl font-bold text-[#5800B0]'>Premium</h2>
                <p className='text-lg lg:px-5'>(Explanation soon)</p>
            </div>
        </div>
      </div>
       ...
       {/* Are you still tuning for free ?------------- */}
              <div className="flex justify-center ">
                <div className="bg-white/30 backdrop-blur-sm shadow-lg max-w-[1440px] w-full my-10 border border-white rounded-2xl flex flex-col items-center text-center justify-center p-14 space-y-8"> 
                  ...
                  <p className='text-lg'>The time is now, Make your best move! 
                  <br/>Download Stereo Pay.</p>
